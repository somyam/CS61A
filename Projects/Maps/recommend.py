...
def best_predictor(user, restaurants, feature_fns):
    ...
    predictors = [find_predictor(user, reviewed, feat) for feat in feature_fns]
...
def rate_all(user, restaurants, feature_fns):
    ...
    for restaurant in restaurants:
        ...
        if restaurant in reviewed:
            dict_all[rest_name] = user_rating(user, rest_name)

        else:
            dict_all[rest_name] = predictor(restaurant)
