...
(define (enumerate s)
  ...
  (define (helper k output s)
    (if (null? s) output
    (helper (+ k 1) (append output (list(cons k (list(car s))))) (cdr s))
...
(define (list-change total denoms)
  ...
  (cond
    ...
    (else (append (cons-all 
              ...
              (car denoms) (list-change (- total (car denoms)) denoms)) (list-change total (cdr denoms))))
  )
  )
